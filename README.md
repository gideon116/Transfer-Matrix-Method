...
This project is associated with the calculation of the real and imaginary parts of the refractive index of CaZn₂P₂ (see [this paper](https://doi.org/10.1002/aenm.202402640)). However, the concepts and the calculation apply to any system. You can find a short video description in this YouTube video https://www.youtube.com/watch?v=R5wKVoK5ZH4.
